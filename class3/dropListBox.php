...
รหัสบัตรประชาชน : <input type="text" maxlength="13" name="id" /><br />
ชื่อ-นามสกุล : <input type="text" size="40" name="nameSurename" /><br />
เพศ : <select name="sex" ><option value="male" />ชาย <option value="female" />หญิง</select><br />
งานอดิเรก :
<input type="checkbox" name="chk1" value="book" /> อ่านหนังสือ <input type="checkbox" name="chk2" value="tv" /> ดูโทรทัศน์ <input type="checkbox" name="chk3" value="sport" /> เล่นกีฬา
<br/>
เลือกสี :
